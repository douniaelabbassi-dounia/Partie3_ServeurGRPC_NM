...
public final class ServiceGrpcNM {

  private ServiceGrpcNM() {}
  ...
  public static io.grpc.MethodDescriptor<ma.enset.stubs.Jeu.Request,
    ...
    if ((getNbrMagiqueMethod = ServiceGrpcNM.getNbrMagiqueMethod) == null) {
      synchronized (ServiceGrpcNM.class) {
        if ((getNbrMagiqueMethod = ServiceGrpcNM.getNbrMagiqueMethod) == null) {
          ServiceGrpcNM.getNbrMagiqueMethod = getNbrMagiqueMethod =
